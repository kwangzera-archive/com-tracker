...
parser.add_argument("--image_file", default="public/kettle.png", help="Input image")
...
# cv2.imwrite('private_tests/out/Output-Keypoints.jpg', frameCopy)
# cv2.imwrite('private_tests/out/Output-Skeleton.jpg', frame)
